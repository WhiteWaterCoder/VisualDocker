...
namespace VisualDocker
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class DockerManagementToolWindowCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DockerManagementToolWindowCommand"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        private DockerManagementToolWindowCommand(Package package)
        {
            if (package == null)
            {
        ...
        /// </summary>
        public static DockerManagementToolWindowCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            Instance = new DockerManagementToolWindowCommand(package);
        }
